...
WEIGHTS_INDEX_NAME = "paddle_model.bin.index.json"
SAFE_WEIGHTS_NAME = "paddle_model.safetensors"
SAFE_WEIGHTS_INDEX_NAME = "paddle_model.safetensors.index.json"
...
TORCH_DISTRIBUTED_OPERATION_TYPES = CUDA_DISTRIBUTED_TYPES + ["MULTI_GPU", ]
