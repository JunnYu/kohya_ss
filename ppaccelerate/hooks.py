...
def set_module_tensor_to_device(
    ...
    dtype: Optional[Union[str, paddle.dtype]] = None,
    fp16_statistics: Optional[paddle.Tensor] = None,
):
    pass
def named_module_tensors(module: nn.Layer, include_buffers: bool = True, recurse=None, include_sublayers: bool = False):
    """
    ...
    """
    for named_parameter in module.named_parameters(include_sublayers=include_sublayers):
        yield named_parameter

    if include_buffers:
        for named_buffer in module.named_buffers(include_sublayers=include_sublayers):
            yield named_buffer
...
class AlignDevicesHook(ModelHook):
    ...
    Args:
        execution_device (`str`, *optional*):
            The device on which inputs and model weights should be placed before the forward pass.
        offload (`bool`, *optional*, defaults to `False`):
            Whether or not the weights should be offloaded after the forward pass.
        io_same_device (`bool`, *optional*, defaults to `False`):
            Whether or not the output should be placed on the same device as the input was.
        weights_map (`Mapping[str, paddle.Tensor]`, *optional*):
    ...
    def __init__(
        self,
        execution_device: Optional[Union[int, str]] = None,
        offload: bool = False,
        ...
        if self.offload:
            for name, _ in named_module_tensors(
                ...
                if "weight" in name and name.replace("weight", "SCB") in self.weights_map.keys():
                    if self.weights_map[name].dtype == paddle.int8:
...
def attach_execution_device_hook(
    module: nn.Layer,
    execution_device: Union[int, str, str],
    skip_keys: Optional[Union[str, List[str]]] = None,
    ...
    Args:
        ...
        execution_device (`int`, `str` or `str`):
            The device on which inputs and model weights should be placed before the forward pass.
...
def attach_align_device_hook_on_blocks(
    module: nn.Layer,
    execution_device: Optional[Union[str, Dict[str, str]]] = None,
    ...
    Args:
        module (`nn.Layer`):
            The module where we want to attach the hooks.
        execution_device (`str` or `Dict[str, str]`, *optional*):
...
class CpuOffload(ModelHook):
    ...
    Args:
        execution_device(`str`, `int` or `str`, *optional*):
    ...
    def __init__(
        self,
        execution_device: Optional[Union[str, int, str]] = None,
